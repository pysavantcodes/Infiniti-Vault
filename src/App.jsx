...
export default function App() {
  return (
    <section>
      ...
      <section class="bg-[#b9ff66] text-black">
        <div class="grid max-w-[1250px] px-7 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light lg:mb-8 md:text-lg lg:text-xl text-black">
